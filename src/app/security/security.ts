...
export class Security implements OnInit {
  ...
  readonly defaultName     = 'Security';
  readonly defaultIcon     = '🛡️';
  readonly defaultFeatures = ['Threat Detection', 'SSL Setup', 'Vulnerability Scan'];
  readonly defaultPrice    = 4000;
  ...
  get pkgDesc()     { return this.pkg.description || 'Comprehensive security audits and penetration testing to ensure data safety.'; }
  ...
  get iconGradient(): string {
    ...
    return map[this.pkg.badgeColor || ''] || 'linear-gradient(135deg,#ef4444,#b91c1c)';
  }
